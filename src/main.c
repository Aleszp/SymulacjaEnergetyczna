...
int main(void)
{
	...
	const int daymax=365;
	
	FILE* out1=stdout;
	FILE* out2=stderr;

	fprintf(out1,"Dzienne zużycie [kWh]\n");
	fprintf(out1,"miesiac,dzien,Cx1,C11Ponad40kW,C12aSzczyt,C12aPozaszczyt,C12aPonad50kW,C12aPonad40kW,C12bSzczyt,C12bPozaszczyt,C12bPonad50kW,C12bPonad40kW,C22aSzczyt,C22aPozaszczyt,C22aPonad50kW,C22bSzczyt,C22bPozaszczyt,C22bPonad50kW,C23Szczyt1,C23Szczyt2,C23Pozaszczyt,C23Ponad50kW1,C23Ponad50kW2\n");
	
	fprintf(out2,"Dzienny koszt [zł]:\n");
	fprintf(out2,"miesiac,dzien,C11,C12a,C12b,C21,C22a,C22b,C23\n");
	...
	{	
		...
		if(day%6==0 || day%7==0)	//brak pracy w weekendy
		{
			...
			//Dzienne zużycie
			fprintf(out1,"%i,%i,%0.4lf,%0.4lf,%0.4lf,%0.4lf,%0.4lf,%0.4lf,%0.4lf,%0.4lf,%0.4lf,%0.4lf,%0.4lf,%0.4lf,%0.4lf,%0.4lf,%0.4lf,%0.4lf,%0.4lf,%0.4lf,%0.4lf,%0.4lf,%0.4lf\n",month,day,Wx1[0],Wx1[1], W12a[0],W12a[1],W12a[2],W12a[3], W12b[0],W12b[1],W12b[2],W12a[3], W22a[0],W22a[1],W22a[2], W22b[0],W22b[1],W22b[2], W23[0],W23[1],W23[2],W23[3],W23[4]);	
			//Dzienny koszt
			fprintf(out2,"%i,%i,%0.4lf,%0.4lf,%0.4lf,%0.4lf,%0.4lf,%0.4lf,%0.4lf\n",month,day,Wx1[0]*C11,C12a[0]*W12a[0]+C12a[1]*W12a[1],C12b[0]*W12b[0]+C12b[1]*W12b[1],Wx1[0]*C21,C22a[0]*W22a[0]+C22a[1]*W22a[1],C22b[0]*W22b[0]+C22b[1]*W22b[1],C23[0]*W23[0]+C23[1]*W23[1]+C23[2]*W23[2]);
		...
		Pamp=Knoc+oswietlenie;
		segment(month,tPolnoc1,tOtwarcie,Pamp,0.0,0.0,&Pmax,Wx1,W12a,W12b,W22a,W22b,W23);
		...
		segment(month,tOtwarcie,tRozruch,Pamp,0.0,0.0,&Pmax,Wx1,W12a,W12b,W22a,W22b,W23);
		
		//Podgrzewanie
		segment(month,tRozruch,tPodtrzymanie,Pamp,Prozruch,Prozruch,&Pmax,Wx1,W12a,W12b,W22a,W22b,W23);
		
		//Podtrzymanie
		segment(month,tPodtrzymanie,tChlodzenie,Pamp,Ppodtrzymanie,Ppodtrzymanie,&Pmax,Wx1,W12a,W12b,W22a,W22b,W23);
		
		//Chłodzenie
		segment(month,tChlodzenie,tZmiana,Pamp,Pchłodzenie,Pchłodzenie*(tStop-tZmiana)/(tStop-tChlodzenie),&Pmax,Wx1,W12a,W12b,W22a,W22b,W23);
		
		//Koniec pracy w zakładzie, dalsze chłodzenie (tylko stygnący piec, oświetlenie i klimatyzacja)
		Pamp=Knoc+oswietlenie;
		segment(month,tZmiana,tStop,Pamp,Pchłodzenie*(tStop-tZmiana)/(tStop-tChlodzenie),0.0,&Pmax,Wx1,W12a,W12b,W22a,W22b,W23);
		
		//Koniec schłodzenia, brak pracy w zakładzie (tylko oświetlenie i klimatyzacja)
		segment(month,tStop,tPolnoc2,Pamp,0.0,0.0,&Pmax,Wx1,W12a,W12b,W22a,W22b,W23);
